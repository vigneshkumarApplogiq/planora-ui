...
export function Sidebar({ activeModule, user }: SidebarProps) {
  ...
  return (
    <aside className="flex flex-col w-64 bg-gradient-to-b from-green-50 to-green-100 dark:from-green-900 dark:to-green-800 border-r border-green-200/50 dark:border-green-700/50 overflow-y-auto">
      <div className="p-4">
        {/* Role Badge */}
        <div className="mb-6 p-4 bg-gradient-to-r from-white/80 to-green-50 dark:from-green-900/50 dark:to-green-800/50 rounded-xl border border-green-200/50 dark:border-green-600/30 shadow-lg backdrop-blur-sm">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <span className="text-sm font-medium text-black dark:text-green-50">
                {roleInfo.label}
              </span>
        ...
        <nav className="space-y-2">
          {navigationItems.map((item) => {
            ...
            const isActive =
              location.pathname === item.path || activeModule === item.id;
            ...
            return (
              <Button
                ...
                className={cn(
                  ...
                  isActive &&
                    "bg-gradient-to-r from-[#28A745]/20 to-[#28A745]/10 text-[#28A745] border border-[#28A745]/30  hover:from-[#28A745]/30 hover:to-[#28A745]/20"
                )}
              ...
              >
                ...
                {isActive && (
                  <ChevronRight className="w-4 h-4 ml-2 text-[#28A745]" />
                )}
              </Button>
            );
          })}
