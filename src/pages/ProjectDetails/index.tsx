...
import { KanbanReportsView } from "./Kanban/Reports/KanbanReportsView";
...
export function ProjectDetails({
  ...
  const [masterData, setMasterData] = useState<ProjectMastersResponse | null>(
    null
  );
  ...
  // Function to update the active view in URL
          ...
          <Card className="shadow-xl border-0 bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm">
            <CardContent className="p-8">
              ...
              <p className="text-muted-foreground">
                The requested project could not be found or may have been
                deleted.
              </p>
            </CardContent>
          </Card>
      ...
      case "epics":
        return (
          <Epic
            projectId={projectId}
            user={user}
            teamMembers={project?.team_members_detail || []}
          />
        );
      case "backlog":
        return (
          <BacklogView projectId={projectId} user={user} project={project} />
        );
      case "sprints":
        ...
        >
          ...
          <div className="p-3 border-b border-gray-100 dark:border-gray-700 overflow-y-auto">
            ...
            <div className="flex items-center gap-1">
              {project?.teamMembers
                ?.slice(0, 3)
                .map((memberId: string, index: number) => (
                  <div
                    key={memberId || index}
