...
export function ReportsView({ project, user }: ReportsViewProps) {
        ...
        <div className="flex items-center justify-between">
          <div className="flex-1">
            ...
            {trend && trendValue !== undefined && (
              <div
                className={`flex items-center space-x-1 text-sm mt-2 ${getTrendColor(
                  trend
                )}`}
              >
                {getTrendIcon(trend)}
                  ...
                  if (active && payload && payload.length) {
                    return (
                      <div className="bg-white dark:bg-gray-800 p-3 border rounded shadow-lg">
                        ...
                        <p className="text-sm">
                          Tasks: {payload[0].payload.tasksCompleted}/
  ...
  const MilestoneAchievementTrend = () => {
    ...
    const data = months.map((month, index) => ({
      month,
      achieved: mockWaterfallData.milestones
        .filter((m) => m.status === "completed")
        .slice(0, (index + 1) * 2).length,
      planned: (index + 1) * 2,
    }));
  ...
  const MilestoneAchievementTimeline = () => {
    const data = mockWaterfallData.milestones
      .slice(0, 8)
      .map((milestone, index) => ({
        name: `M${index + 1}`,
                  ...
                  if (active && payload && payload.length) {
                    return (
                      <div className="bg-white dark:bg-gray-800 p-3 border rounded shadow-lg">
                        ...
                        <p className="text-sm">
                          Status: {payload[0].payload.actual}%
                        </p>
                      </div>
                    );
                  }
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Waterfall project analytics and performance metrics
          </p>
        </div>
      ...
      >
                ...
                <div className="flex items-center justify-between p-4 bg-muted rounded-lg">
                  <div>
                    ...
                    <p className="text-lg font-semibold">
                      {formatDate(
                        new Date(mockWaterfallData.timeline.projectStart),
                        "MMM d, yyyy"
                      )}{" "}
                      -{" "}
                      {formatDate(
                        new Date(mockWaterfallData.timeline.plannedEnd),
                        "MMM d, yyyy"
                      )}
                    </p>
                  </div>
                ...
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-medium">
                      {mockWaterfallData.timeline.daysElapsed}
                    </span>
                  </div>
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-medium">
                      {mockWaterfallData.timeline.daysRemaining}
                    </span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-muted-foreground">
                    ...
                    <span className="font-medium">
                      {formatDate(
                        new Date(mockWaterfallData.timeline.projectedEnd),
                        "MMM d, yyyy"
                      )}
                    </span>
                  </div>
                ...
                <div>
                  <div className="flex justify-between text-sm mb-2">
                    ...
                    <span className="font-medium">
                      {Math.round(
                        (mockWaterfallData.timeline.daysElapsed /
                          mockWaterfallData.timeline.totalPlannedDays) *
                          100
                      )}
                      %
                    </span>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="p-3 bg-red-50 dark:bg-red-950 rounded-lg">
                    ...
                    <p className="text-2xl font-bold text-red-800 dark:text-red-200">
                      {mockWaterfallData.riskMetrics.highRisks}
                    </p>
                  </div>
                  <div className="p-3 bg-yellow-50 dark:bg-yellow-950 rounded-lg">
                    ...
                    <p className="text-2xl font-bold text-yellow-800 dark:text-yellow-200">
                      {mockWaterfallData.riskMetrics.mediumRisks}
                    </p>
                  </div>
                  <div className="p-3 bg-orange-50 dark:bg-orange-950 rounded-lg">
                    ...
                    <p className="text-2xl font-bold text-orange-800 dark:text-orange-200">
                      {mockWaterfallData.qualityMetrics.bugsFound -
                        mockWaterfallData.qualityMetrics.bugsFixed}
                    </p>
                  </div>
                  <div className="p-3 bg-green-50 dark:bg-green-950 rounded-lg">
                    ...
                    <p className="text-2xl font-bold text-green-800 dark:text-green-200">
                      {mockWaterfallData.qualityMetrics.testCoverage}%
                    </p>
                  </div>
                </div>
              </CardContent>
        ...
        <TabsContent value="phases" className="space-y-6 mt-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <MetricCard
              ...
              value={Math.round(
                mockWaterfallData.phases.reduce(
                  (acc, p) => acc + p.progress,
                  0
                ) / mockWaterfallData.phases.length
              )}
              unit="%"
              icon={TrendingUp}
            />
                  ...
                  >
                    ...
                    <div className="grid grid-cols-3 gap-4 text-sm">
                      ...
                      <div>
                        ...
                        <p className="font-semibold">
                          {phase.milestonesAchieved}/{phase.totalMilestones}
                        </p>
                      </div>
                      <div>
        ...
        <TabsContent value="milestones" className="space-y-6 mt-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <MetricCard
              title="Achieved"
              value={
                mockWaterfallData.milestones.filter(
                    ...
                    <div className="flex-1">
                      ...
                      <div className="ml-7 space-y-1">
                        ...
                        <p className="text-sm text-muted-foreground">
                          ...
                          {milestone.deliverablesCompleted}/
        ...
        <TabsContent value="deliverables" className="space-y-6 mt-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <MetricCard
              ...
              subtitle={`${Math.round(
                (mockWaterfallData.deliverables.completed /
                  (mockWaterfallData.deliverables.completed +
                    mockWaterfallData.deliverables.inProgress +
                    mockWaterfallData.deliverables.notStarted)) *
                  100
              )}% completion rate`}
              icon={CheckCircle}
            />
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                {mockWaterfallData.deliverables.byPhase.map(
                  (phaseData, index) => (
        ...
        <TabsContent value="team" className="space-y-6 mt-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <MetricCard
              title="Total Hours"
              value={mockWaterfallData.teamPerformance.reduce(
                (acc, m) => acc + m.hoursLogged,
                0
              )}
              unit="h"
              icon={Clock}
            ...
            <MetricCard
              ...
              value={Math.round(
                mockWaterfallData.teamPerformance.reduce(
                  (acc, m) => acc + m.efficiency,
                  0
                ) / mockWaterfallData.teamPerformance.length
              )}
              unit="%"
              icon={TrendingUp}
            />
